...
@section('content')
  <!-- breadcrumb_section - start
                                            ================================================== -->
  <div class="breadcrumb_section" style="padding-top: 120px">
    <div class="container">
                ...
                <div class="coll-2">
                  <div class="woocommerce-shipping-fields">
                    <h3 id="ship-to-different-address">
                      <label class="checkbox" data-toggle="collapse" data-target="#display_shipping_address">Ship
                        to a different
                        address?
                  ...
                  <tfoot>
                    <tr class="cart-subtotal">
                      ...
                      <td><span class="woocommerce-Price-amount amount"><span
                            class="woocommerce-Price-currencySymbol">$</span>{{ $cart->sum('total') }}</span>
                      </td>
                    </tr>
                    ...
                    <tr class="order-total">
                      ...
                      <td><strong><span class="woocommerce-Price-amount amount"><span
                            ...
                            @if (Session::has('shipping_charge') && Session::has('coupon'))
                              {{ $cart->sum('total') + Session::get('shipping_charge') - Session::get('coupon')['amount'] }}
                            @else
                              {{ $cart->sum('total') + Session::get('shipping_charge') }}
                            @endif
